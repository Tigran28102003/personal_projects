...
# Layer-2 HARQ-forecast walk-forward: smaller warmup + finer refits than the M1/M3 gate splits, so the
# tradeable dev window spans more vol regimes (2021 bull, 2022 bear, 2023-25). HAR warms up in ~1.4y.
VOL_TIMING_MIN_TRAIN_FRAC = 0.25
VOL_TIMING_WF_SPLITS = 16
